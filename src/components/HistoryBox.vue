...
<template>
    <div v-if="history.length > 0"
        ...
        <span
            ...
            @click="handleRemoveHistory(history)">Remove all</span>
            ...
            <li v-for="item in history" :key="item" >
                <div class="flex items-center mx-auto py-2">
                    ...
                    <code
                        ...
                        title="Click to copy" @click="copyHistoryItem(item)">
                        {{ item }}
                    </code>
                    <div class="space-x-2">
                        <button type="button" class="cursor-pointer hover:text-gray-700 dark:hover:text-gray-200"
                            title="Remove" @click="handleEditHistory(item)">
                        ...
                        <button type="button" class="cursor-pointer hover:text-gray-700 dark:hover:text-gray-200"
                            title="Remove" @click="handleRemoveHistory([item])">
